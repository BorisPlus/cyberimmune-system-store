# Система учёта, контроля остатков и поиска товара на предприятии

_Определение_: Предприятие - это склад и места временного размещения товара, в частности, в рамках его движения.
...
* состояние товара на Предприятии всегда соответствует сведениям в информационной системе;

### Подцели безопасности

* не возможны состояния:
  * на Предприятии имеется товар, сведения о котором не внесены в информационную систему;
  * в информационной системе есть сведения о физическом наличии товара, фактически отсутствующем на Предприятии;
